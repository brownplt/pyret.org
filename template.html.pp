<!DOCTYPE html>
◊(require (file "/Users/sk/Desktop/r/sk/website-brown-cs/find-relative-root.rkt"))
◊(define resource-relative-path (here->relative-path here))
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="icon"      href="◊|resource-relative-path|/img/pyret-icon.png">
    ...
    <link rel="stylesheet" type="text/css" href="◊|resource-relative-path|/bootstrap-css/bootstrap-5.0.2-dist/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="◊|resource-relative-path|/css/pygments.css">
    <link rel="stylesheet" type="text/css" href="◊|resource-relative-path|/css/codemirror.css">
    <link rel="stylesheet" type="text/css" href="◊|resource-relative-path|/css/scribble.css">
    <link rel="stylesheet" type="text/css" href="◊|resource-relative-path|/css/custom.css">
    <script src="◊|resource-relative-path|/bootstrap-css/bootstrap-5.0.2-dist/js/bootstrap.min.js">
    <script type="module" src="◊|resource-relative-path|/node_modules/pyret-embed/dist/pyret.js"></script>
    <style>
    ...
    <header class="navbar navbar-expand-lg navbar-light bg-light fixed-top more-navbar-space">
      <div class="container">
        <a href="./index.html" class="navbar-brand">
          <img class="navbar-logo" src="◊|resource-relative-path|/img/pyret-banner.png"></img>
        </a>
        ...
        <div class="collapse navbar-collapse"
          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item"><a class="nav-link fancyhover-above" href="◊|resource-relative-path|/pyret-code/">Why Pyret?</a></li>
            <li class="nav-item"><a class="nav-link fancyhover-above" href="◊|resource-relative-path|/crew/">The Pyret Crew</a></li>
            <li class="nav-item"><a class="nav-link fancyhover-above" href="◊|resource-relative-path|/discuss/">Scuttlebutt</a></li>
